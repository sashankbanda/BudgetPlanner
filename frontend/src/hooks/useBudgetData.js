...
export const useBudgetData = () => {
    ...
    // ✨ ADDED: State for new trend controls ✨
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            const [
                ...
                api.stats.getGranularTrendStats(trendParams), // ✨ UPDATED API call
                api.people.getAll(),
    ...
    }, [filters, selectedAccountId, trendPeriod, trendDateRange.from, trendDateRange.to]); // ✨ ADDED Dependencies
    ...
    }, [loadData]); // ✨ UPDATED to use loadData callback
...
    }, [filters]);
    ...
    return {
        ...
        trendPeriod, trendDateRange, // ✨ EXPORTED new state
